...
<br />
3. Implement M.A.S.H. Game Database (activity.c)
<br /><br />
...
<br />
4. Display M.A.S.H. Game Database (activity.c)
<br /><br />
...
```
<br />
5. Implement M.A.S.H. Game UI (activity.c)
<br /><br />
...
```
<br />
6. Free dynamic memory (activity.c)
<br /><br />
...
1. Expand the folder named LabActivity and open the files named DataNode.c, DataNode.h, mytests.c and activity.c
