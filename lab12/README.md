...
==16199== Command: bin/mycat -f /usr/share/dict/american-english
==16199== 
==16199== 
==16199== HEAP SUMMARY:
...
```
bin/mycat -f /usr/share/dict/american-english > mycat.results.out
...
```
bin/mygrep -s war -f etc/War-and-Peace.txt > mygrep.results.out
grep "war" etc/War-and-Peace.txt > grep.results.out
...
==19185== Command: bin/mywc -f /usr/share/dict/american-english
==19185== 
==19185== 
==19185== HEAP SUMMARY:
...
Testing: Check mygrep results against grep using diff tool
```
bin/mywc -f etc/War-and-Peace.txt 
  66055  580201 3359550
wc  etc/War-and-Peace.txt 
...
==21116== Command: bin/mysort -f /usr/share/dict/american-english -r
==21116== 
Growing Array: 16 -> 32
Growing Array: 32 -> 64
...
```
bin/mysort -f etc/random_words.txt 
Ankara
Romulus
banyans
bridesmaids
...
bin/mysort -f etc/random_words.txt -r
pixel's
bridesmaids
banyans
Romulus
...
1. Expand the folder named src and open the .c file for the current system tool: mycat, mygrep, mysort or mywc
